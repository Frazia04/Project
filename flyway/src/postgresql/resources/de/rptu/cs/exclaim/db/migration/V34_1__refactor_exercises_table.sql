...
CREATE TYPE t_term AS ENUM ('SUMMER', 'WINTER');
CREATE TYPE t_group_join AS ENUM ('NONE', 'GROUP', 'PREFERENCES');
...
(
    ...
    group_join         t_group_join                           NOT NULL DEFAULT 'NONE',
...
SELECT                  id, lecture, 0,      term,         registration_open, group_join::t_group_join
FROM exercises;
