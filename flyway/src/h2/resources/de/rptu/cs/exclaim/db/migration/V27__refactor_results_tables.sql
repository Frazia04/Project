...
(
    ...
    userid              INT                                   NOT NULL,
    attended            ENUM ('PRESENT', 'ABSENT', 'EXCUSED')     NULL,
...
MERGE  INTO studentresults (exercise,   sheet,   userid, attended)
SELECT                    a.exercise, a.sheet, u.userid, (CASE WHEN a.attended THEN 'PRESENT'               ELSE 'ABSENT'               END)
...
MERGE  INTO studentresults (exercise,   sheet,   userid,   deltapoints,   deltapoints_reason)
...
MERGE  INTO students (userid, exerciseid)
...
MERGE  INTO teamresults (exercise, sheet, groupid, teamid)
